            ...
            tokio::select! {
                ...
                _ = tokio::time::sleep_until((last_gamepad_update + std::time::Duration::from_millis(40)).into()) => {
                    ...
                    _ = tokio::time::sleep_until((last_heartbeat_request_packet + std::time::Duration::from_secs(1)).into()) => {
                         ...
                         let packet = Packet::from_packet_type_and_writable(PacketType::Heartbeat, &HeartbeatPacketData {sequence_number: 10003, peer_type: 1, sdk_build_month: 1, sdk_build_year: 2026, sdk_major_version: 11, sdk_minor_version: 1});
