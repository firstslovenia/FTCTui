...
pub struct Robot {
    ...
    /// Information about the robot's hardware (it's configuration)
    pub hardware: Arc<RwLock<RobotConfigurationData>>,
...
impl Robot {
    ...
    pub fn new_empty() -> Robot {
        Robot {
            ...
            opmode_list: None,
            hardware: Arc::new(RwLock::new(RobotConfigurationData::default())),
    ...
    pub fn new_fake() -> Robot {
        Robot {
            ...
            hardware: Arc::new(RwLock::new(RobotConfigurationData {
...
/// Shared data about the robot's hardware configurations
#[derive(Clone, PartialEq, Debug, Default)]
pub struct RobotConfigurationData {
    /// The valid configuration types, if we're received them
    pub configuration_types: Option<Vec<HardwareDeviceType>>,

    /// A list of all the robot's configurations, it we've received it
    pub configurations: Option<Vec<RobotConfigurationFile>>,

    /// The active configuration's metadata, if we've received it
